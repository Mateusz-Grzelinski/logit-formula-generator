...
class AtomGenerator(SyntaxTreeGenerator):
    def __init__(self, math_connectives: Iterable[Union[str, None]] = None, variable_gen: VariableGenerator = None,
                 predicate_gen: PredicateGenerator = None, functor_gen: FunctorGenerator = None):
        self.functor_gen = functor_gen
        self.variable_name_gen = variable_gen
        self.predicate_gen = predicate_gen

        self.allowed_math_connectives = list(math_connectives) if math_connectives else []
    ...
    def generate(self) -> Atom:
        ...
        if math_connective.arity == 1:
            ...
            a = Atom(children=[], math_connective=math_connective, unary_connective=[])
