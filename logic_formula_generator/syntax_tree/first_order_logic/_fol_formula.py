...
from logic_formula_generator.data_model._fol_formula_info import FirstOrderLogicFormulaInfo
...
class FirstOrderLogicFormula(FirstOrderLogicNode):
    ...
    def save_to_file(self, path: str, formula_prefix: str = '', normal_form: typing.Literal['cnf'] = None,
        ...
        from logic_formula_generator.syntax_tree.first_order_logic.exporters.tptp import TPTPExporter
