...
from logic_formula_generator.data_model import CNFFOLFormulaInfo
...
class TPTPHeader:
    ...
    def read_from(self, object: CNFFOLFormulaInfo):
        if isinstance(object, CNFFOLFormulaInfo):
            self.number_of_clause_instances = object.number_of_instances['clauses']
            ...
            self.number_of_non_horn_clauses = object.number_of_instances[
                                                  'clauses'] - object.number_of_horn_clauses_instances
            ...
            self.number_of_atom_instances = object.number_of_instances['atoms']
            ...
            self.number_of_predicates = object.number_of['predicates']
            self.number_of_propositional_predicates = object.number_of_propositional_predicates

            self.number_of_variables = object.number_of_instances['variables']
            ...
            self.number_of_functors = object.number_of['functors']
            self.number_of_constant_functors = object.number_of_constant_functors
            self.number_of_functors_instances = object.number_of_instances['functors']
