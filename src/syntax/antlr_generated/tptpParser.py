...
class tptpParser(Parser):
    ...
    def tptp_file(self):
        ...
        try:
            ...
            while (((_la) & ~0x3f) == 0 and ((1 << _la) & (
                    (1 << tptpParser.T__0) | (1 << tptpParser.T__3) | (1 << tptpParser.T__4) | (
                    1 << tptpParser.T__5) | (1 << tptpParser.T__6) | (1 << tptpParser.T__7) | (1 << tptpParser.T__8) | (
                            1 << tptpParser.T__37))) != 0):
                self.state = 402
                self.tptp_input()
                self.state = 407
                self._errHandler.sync(self)
    ...
    def tptp_input(self):
        ...
        try:
            ...
            if token in [tptpParser.T__0, tptpParser.T__3, tptpParser.T__4, tptpParser.T__5, tptpParser.T__6,
                         tptpParser.T__7, tptpParser.T__8]:
                self.enterOuterAlt(localctx, 1)
                self.state = 410
    ...
    def thf_atom(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [tptpParser.Dollar_word, tptpParser.Dollar_dollar_word, tptpParser.Lower_word,
                         tptpParser.Single_quoted]:
                self.enterOuterAlt(localctx, 1)
                self.state = 614
                self.thf_function()
                pass
                ...
                self.defined_term()
                pass
            elif token in [tptpParser.Or, tptpParser.And, tptpParser.Iff, tptpParser.Impl, tptpParser.If,
                           tptpParser.Niff, tptpParser.Nor, tptpParser.Nand, tptpParser.Not, tptpParser.ForallComb,
                           tptpParser.Infix_inequality, tptpParser.Infix_equality, tptpParser.ExistsComb,
                           tptpParser.ChoiceComb, tptpParser.DescriptionComb, tptpParser.EqComb, tptpParser.Assignment]:
                self.enterOuterAlt(localctx, 4)
                self.state = 617
                self.thf_conn_term()
                pass
    ...
    def thf_conn_term(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [tptpParser.Iff, tptpParser.Impl, tptpParser.If, tptpParser.Niff, tptpParser.Nor,
                         tptpParser.Nand, tptpParser.Infix_inequality, tptpParser.Infix_equality,
                         tptpParser.Assignment]:
                self.enterOuterAlt(localctx, 1)
                self.state = 638
                self.thf_pair_connective()
                pass
                ...
                pass
            elif token in [tptpParser.Not, tptpParser.ForallComb, tptpParser.ExistsComb, tptpParser.ChoiceComb,
                           tptpParser.DescriptionComb, tptpParser.EqComb]:
                self.enterOuterAlt(localctx, 3)
                self.state = 640
                self.thf_unary_connective()
                pass
    ...
    def thf_typeable_formula(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [tptpParser.Or, tptpParser.And, tptpParser.Iff, tptpParser.Impl, tptpParser.If, tptpParser.Niff,
                         tptpParser.Nor, tptpParser.Nand, tptpParser.Not, tptpParser.ForallComb,
                         tptpParser.Infix_inequality, tptpParser.Infix_equality, tptpParser.ExistsComb,
                         tptpParser.ChoiceComb, tptpParser.DescriptionComb, tptpParser.EqComb, tptpParser.Assignment,
                         tptpParser.Real, tptpParser.Rational, tptpParser.Integer, tptpParser.Dollar_word,
                         tptpParser.Dollar_dollar_word, tptpParser.Upper_word, tptpParser.Lower_word,
                         tptpParser.Single_quoted, tptpParser.Distinct_object]:
                self.enterOuterAlt(localctx, 1)
                self.state = 663
                self.thf_atom()
                pass
    ...
    def tff_unary_formula(self):
        ...
        try:
            ...
            if token in [tptpParser.Not]:
                ...
                self.tff_unitary_formula()
                pass
            elif token in [tptpParser.T__17, tptpParser.T__18, tptpParser.T__23, tptpParser.T__24, tptpParser.T__25,
                           tptpParser.Real, tptpParser.Rational, tptpParser.Integer, tptpParser.Dollar_word,
                           tptpParser.Dollar_dollar_word, tptpParser.Upper_word, tptpParser.Lower_word,
                           tptpParser.Single_quoted, tptpParser.Distinct_object]:
                self.enterOuterAlt(localctx, 2)
    ...
    def tff_monotype(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [tptpParser.Dollar_word, tptpParser.Upper_word, tptpParser.Lower_word,
                         tptpParser.Single_quoted]:
                self.enterOuterAlt(localctx, 1)
                self.state = 997
                self.tff_atomic_type()
    ...
    def tcf_logic_formula(self):
        ...
        try:
            ...
            if token in [tptpParser.Forall]:
                ...
                pass
            elif token in [tptpParser.T__9, tptpParser.T__17, tptpParser.T__18, tptpParser.T__23, tptpParser.T__24,
                           tptpParser.T__25, tptpParser.Not, tptpParser.Real, tptpParser.Rational, tptpParser.Integer,
                           tptpParser.Dollar_word, tptpParser.Dollar_dollar_word, tptpParser.Upper_word,
                           tptpParser.Lower_word, tptpParser.Single_quoted, tptpParser.Distinct_object]:
                self.enterOuterAlt(localctx, 2)
                self.state = 1051
                self.cnf_formula()
                pass
    ...
    def fof_term(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [tptpParser.Real, tptpParser.Rational, tptpParser.Integer, tptpParser.Dollar_word,
                         tptpParser.Dollar_dollar_word, tptpParser.Lower_word, tptpParser.Single_quoted,
                         tptpParser.Distinct_object]:
                self.enterOuterAlt(localctx, 1)
                self.state = 1198
    ...
    def fof_function_term(self):
        ...
        try:
            ...
            if token in [tptpParser.Lower_word, tptpParser.Single_quoted]:
                ...
                self.fof_plain_term()
                pass
            elif token in [tptpParser.Real, tptpParser.Rational, tptpParser.Integer, tptpParser.Dollar_word,
                           tptpParser.Distinct_object]:
                self.enterOuterAlt(localctx, 2)
                self.state = 1206
                self.fof_defined_term()
    ...
    def cnf_formula(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [tptpParser.T__17, tptpParser.T__18, tptpParser.T__23, tptpParser.T__24, tptpParser.T__25,
                         tptpParser.Not, tptpParser.Real, tptpParser.Rational, tptpParser.Integer,
                         tptpParser.Dollar_word, tptpParser.Dollar_dollar_word, tptpParser.Upper_word,
                         tptpParser.Lower_word, tptpParser.Single_quoted, tptpParser.Distinct_object]:
                self.enterOuterAlt(localctx, 1)
                self.state = 1264
    ...
    def th0_quantifier(self):
        ...
        try:
            ...
            if not (((((_la - 61)) & ~0x3f) == 0 and ((1 << (_la - 61)) & (
                    (1 << (tptpParser.Lambda - 61)) | (1 << (tptpParser.Choice - 61)) | (
                    1 << (tptpParser.Description - 61)))) != 0)):
    ...
    def thf_pair_connective(self):
        ...
        try:
            ...
            if token in [tptpParser.Infix_equality]:
                ...
                self.match(tptpParser.Infix_inequality)
                pass
            elif token in [tptpParser.Iff, tptpParser.Impl, tptpParser.If, tptpParser.Niff, tptpParser.Nor,
                           tptpParser.Nand]:
                self.enterOuterAlt(localctx, 3)
                self.state = 1299
                self.binary_connective()
    ...
    def thf_unary_connective(self):
        ...
        try:
            ...
            if token in [tptpParser.Not]:
                ...
                self.unary_connective()
                pass
            elif token in [tptpParser.ForallComb, tptpParser.ExistsComb, tptpParser.ChoiceComb,
                           tptpParser.DescriptionComb, tptpParser.EqComb]:
                self.enterOuterAlt(localctx, 2)
                self.state = 1304
    ...
    def th1_unary_connective(self):
        ...
        try:
            ...
            self.state = 1307
            _la = self._input.LA(1)
            if not (((((_la - 53)) & ~0x3f) == 0 and ((1 << (_la - 53)) & (
                    (1 << (tptpParser.ForallComb - 53)) | (1 << (tptpParser.ExistsComb - 53)) | (
                    1 << (tptpParser.ChoiceComb - 53)) | (1 << (tptpParser.DescriptionComb - 53)) | (
                            1 << (tptpParser.EqComb - 53)))) != 0)):
                self._errHandler.recoverInline(self)
            else:
                self._errHandler.reportMatch(self)
                self.consume()
    ...
    def binary_connective(self):
        ...
        try:
            ...
            if not ((((_la) & ~0x3f) == 0 and ((1 << _la) & (
                    (1 << tptpParser.Iff) | (1 << tptpParser.Impl) | (1 << tptpParser.If) | (1 << tptpParser.Niff) | (
                    1 << tptpParser.Nor) | (1 << tptpParser.Nand))) != 0)):
                self._errHandler.recoverInline(self)
            else:
                self._errHandler.reportMatch(self)
                self.consume()
    ...
    def number(self):
        ...
        try:
            ...
            if not (((((_la - 74)) & ~0x3f) == 0 and ((1 << (_la - 74)) & (
                    (1 << (tptpParser.Real - 74)) | (1 << (tptpParser.Rational - 74)) | (
                    1 << (tptpParser.Integer - 74)))) != 0)):
                self._errHandler.recoverInline(self)
            else:
                self._errHandler.reportMatch(self)
                self.consume()
