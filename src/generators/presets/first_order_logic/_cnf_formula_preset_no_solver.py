...
import src.generators.syntax_tree_generators.first_order_logic.normal_forms as fol_normal_form_gen
from src.generators import SyntaxTreeGenerator
from src.syntax_tree.first_order_logic import FirstOrderLogicFormula


class CNFFormulaPresetNoSolver(SyntaxTreeGenerator):
    ...
    def generate(self) -> FirstOrderLogicFormula:
        ...
        F = fol_normal_form_gen.CNFFormulaGenerator(
            ...
            negation_probability=self.literal_negation_chance
        )
        return F.generate()
