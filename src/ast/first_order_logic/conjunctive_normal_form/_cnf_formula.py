...
from src.ast.first_order_logic.info.cnf_formula_info import CNFFormulaInfo
...
class CNFFormula(Container, FirstOrderLogicElement):
    ...
    def get_info(self) -> CNFFormulaInfo:
        from src.ast.first_order_logic.visitors.cnf_formula_visitor import CNFFormulaVisitor
