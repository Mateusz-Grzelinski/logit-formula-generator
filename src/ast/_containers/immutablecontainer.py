...
class ImmutableContainer(_ContainerBase, Hashable):
    ...
    def __setitem__(self, i: int, o: ItemType) -> None:
        raise NotImplementedError('Cannot set item in immutable _containers')

    def __delitem__(self, i: int) -> None:
        raise NotImplementedError('Cannot delete item in immutable _containers')
    ...
    def insert(self, index: int, object: ItemType) -> None:
        raise NotImplementedError('Cannot insert item to immutable _containers')
